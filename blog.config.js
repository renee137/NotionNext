...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Renee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Renee的博客随记', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https:/reneediary.com', // 网站地址
